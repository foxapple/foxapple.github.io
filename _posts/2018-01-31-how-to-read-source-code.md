...
这两天工作不多，我一直在阅读业务代码，由于是 Android 的 framework 层的代码，自己不知如何下手，于是去知乎取经，看到了大多数人的观点还是这样的：最一开始的时候要抓住主线，不要管细节。等上手后再慢慢补充细节，这样的方式，我回想了这两周我看的源码，自己总结的 workflow，确实是一个相同的道理。所以我就想在具体的描述一下这个方法，并且不局限于 Android framework 层的代码。
